...
%
\begin{outerlist}
        \item[] \textbf{Senior Computer Vision Engineer} at \ac{CVRL}, \ac{ICS}, \ac{FORTH} \hfill \textbf{1/2/2019 - Present}
        \begin{innerlist}
...
\begin{innerlist}
\item Citations: 2396, h-index: 13
\item Most cited visual hand tracking paper of all time: ``Efficient model-based 3D tracking of hand articulations using Kinect.'' (1181 citations)
\end{innerlist}
\end{outerlist}
