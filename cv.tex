...
%\item Marital status: Married, with children
...
%}{LinkedIn} accounts
% \item \textit{Voice:} +30 2811 392554
\item \textit{E-mail:} \href{mailto:kyriazis@ics.forth.gr}{nkyriazis@gmail.com}
\end{innerlist}
\end{minipage}
...
%
Human Centric Computer Vision, Machine Learning, Spatial Computing, Photogrammetry, Radiance Fields, Software Engineering, Super-Computing, Computer Graphics, Optimization Theory.
...
%
\begin{outerlist}
        \item[] \textbf{Co-founder and CEO} at \textbf{SceneOpsis} \hfill \textbf{5/9/2023 - Present}
        \begin{innerlist}
                \item Leading the democratization of spatial computing for the proliferation of remote appreciation.
                \item Involved in operations and pushing the envelope on contemporary structure for motion, photogrammetry, and novel view synthesis (radiance fields).
                \item Skillset and responsibilities:
                \begin{innerlist}
                    \item Leadership and management
                    \item End-to-end tooling (full-stack development)
                    \item 3D development (Unity)
                    \item Mobile XR development
                    \item Deep understanding of Computer Vision and AI
                    \item Deployment in the cloud
                    \item Stakeholder engagement
                    \item Fundraising
                \end{innerlist}
        \end{innerlist}

        \item[] \textbf{Senior Computer Vision Engineer} at \ac{CVRL}, \ac{ICS}, \ac{FORTH} \hfill \textbf{1/2/2019 - 24/3/2024}
        \begin{innerlist}
...
\section{Impact}
\begin{outerlist}
\item[] \href{https://scholar.google.gr/citations?user=fUsz0D8AAAAJ}{Google Scholar} (last update: 24/11/2021)
\begin{innerlist}
\item Citations: 2.824, h-index: 13
\item Most cited visual hand tracking paper of all time: ``Efficient model-based 3D tracking of hand articulations using Kinect.'' (1348 citations)
\end{innerlist}
\end{outerlist}
