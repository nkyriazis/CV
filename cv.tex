...
\begin{outerlist}
  ...
  \begin{innerlist}
    \item Host: Associate Prof. George Papagiannakis (UOC), CEO/CTO/Co-founder
...
\item[] \textbf{NVidia hardware grant} \hfill \textbf{16/1/2019}
    \begin{innerlist}
        ...
        \item Proposal: CUDA-enabled model-based framework on embedded systems
...
3d hand estimation through analysis by synthesis        \item Award: NVidia Jetson TK1 DevKit
    \end{innerlist}
...
%        \item Scope: Graduate students (MsC, PhD) across all departments of the 5 schools which comprise the University of Crete
%        \item Object: To award students whose research has significantly contributed to the advancement of their research field
        \item Sponsored by the University of Crete. Awarded to the top performing graduate student (MSc, PhD) across all departments of the 5 schools which comprise the University of Crete.
    \end{innerlist}
...
\item[] B.Sc., 
        \href{http://www.csd.uoc.gr/}
             {Computer Science Department}, \hfill \textbf{1/2/2006}
        \begin{innerlist}
...
\begin{outerlist}
        \item []
    \begin{innerlist}
        \item Computer Vision and Image Understanding (CVIU) -- Elsevier
        \item Computer-Aided Design (CAD) - Elsevier
        \item IEEE Transactions on Cybernetics (CYB)
        \item IEEE Transactions on Human-Machine Systems (THMS)
        \item IEEE Transactions on Pattern Analysis and Machine Intelligence (TPAMI)
        \item International Journal of Computer Vision (IJCV) -- Springer
...
\begin{outerlist}
        \item []
    \begin{innerlist}
        \item IEEE Computer Vision and Pattern Recognition
